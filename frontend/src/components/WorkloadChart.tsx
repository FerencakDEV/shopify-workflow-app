...
const WorkloadChart = () => {
  ...
  const maxInProgress = Math.max(...workloadData.map((x) => x.inProgress));
  const maxAssigned = Math.max(...workloadData.map((x) => x.assigned));
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative h-3 bg-orange-100 rounded w-full max-w-[180px]">
                    <div
                      ...
                      style={{ width: `${(entry.inProgress / (maxInProgress || 1)) * 100}%` }}
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative h-3 bg-gray-200 rounded w-full max-w-[180px]">
                    <div
                      ...
                      style={{ width: `${(entry.assigned / (maxAssigned || 1)) * 100}%` }}
                    />
                  </div>
                </div>
              </div>
